...
export const LOCAL_TOKEN_LIST = 'https://raw.githubusercontent.com/tokencontent/tokenlist/main/token.json'
export const DEFAULT_TOKEN_LIST_URL = '../../localtoken.json'
